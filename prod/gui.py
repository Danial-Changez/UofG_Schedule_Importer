...
def start_task():
    ...
    def worker():
        ...
        button.configure(state="normal", text="Run Parser")
...
term_var = ctk.StringVar(value="W24")

title_label = ctk.CTkLabel(app, text="Enter Term Code:")
title_label.pack(pady=(20, 5))

term_entry = ctk.CTkEntry(app, placeholder_text="i.e. W24", textvariable=term_var)
